...
(define-map listings
    uint {
        ...
        expiry: uint,
        price: uint,
        payment-asset-contract: (optional principal)    ;; the type of accepted payment
    }
)
...
;; returns a listing with a given ID
...
;; updates the whitelist to include the specified asset
...
;; lists an asset in the marketplace
...
;; cancels a listing in the marketplace
...
;; sip010 version of the above function
